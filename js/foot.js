$(function () {
    ...
    $(".zhuanzhi").attr("href", "new.html?id=0");
    $(".jianhzi").attr("href", "new.html?id=1");
    $(".univerity").attr("href", "new.html?id=2");
    $(".company").attr("href", "new.html?id=3");
    $(".example").attr("href", "new.html?id=4");
    $(".problem").attr("href", "new.html?id=5");
